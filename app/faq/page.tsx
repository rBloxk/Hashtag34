...
export default function FAQPage() {
  ...
  const faqData: FAQItem[] = [
    ...
    {
      id: '1',
      question: 'What is Hashtag34 Stories?',
      answer: 'Hashtag34 Stories is a custom apparel and corporate gifting platform that allows you to create personalized t-shirts, hoodies, mugs, and other products. We specialize in high-quality printing and fast delivery.',
      category: 'general',
