 ...
 * 
 * Example:
 *   node scripts/create-super-admin.js admin@hashtag34stories.com Admin123! "Super Admin"
 * 
 * Requirements:
...
if (args.length < 2) {
  ...
  console.error('\nExample:');
  console.error('  node scripts/create-super-admin.js admin@hashtag34stories.com Admin123! "Super Admin"');
  process.exit(1);
}
